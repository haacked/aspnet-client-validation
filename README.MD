...
[![Build Status](https://github.com/haacked/aspnet-validation/workflows/main/badge.svg)](https://github.com/haacked/aspnet-validation/actions)
...
```powershell
git clone https://github.com/haacked/aspnet-validation.git
npm install
